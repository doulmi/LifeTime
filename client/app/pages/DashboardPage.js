...
import { Chip, Paper, Dialog, Popover, DatePicker, RaisedButton, FlatButton } from 'material-ui'
...
import { loadTaskByDate } from '../actions/taskActions'
...
class DashboardPage extends Component {
  constructor(props) {
    ...
    if(this.props.tasks.analyse.length == 0) {
      let start = stop = Timer.getYmd(new Date());
      this.props.loadTaskByDate(start, stop);
    }
  }
      ...
      <div>
        ...
        <div className="row">
          <div className="col-md-8 col-sm-8 col-xs-12">
            ...
            <TaskPieChart tasks={this.props.tasks.analyse} />
          </div>
          <div className="col-md-3 col-sm-4 col-xs-12 col-lg-3">
            <TaskTableChart tasks={this.props.tasks.analyse} />
          </div>
        </div>
        {dialog}
      </div>
...
DashboardPage.propTypes = {
  loadTaskByDate: React.PropTypes.func.isRequired
}
...
export default connect(mapStateToProps, { loadTaskByDate })(DashboardPage)